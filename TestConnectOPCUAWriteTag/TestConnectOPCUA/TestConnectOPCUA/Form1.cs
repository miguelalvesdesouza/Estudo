    ...
    public partial class Form1 : Form
    {
        ...
        private void connectServerCtrl1_ConnectComplete(object sender, EventArgs e)
        {
            ...
            catch (Exception exception)
            {
                ...
                Console.WriteLine("ConnectServerControl " + exception);
            }
        }
...
label2
        ...
        private void MonitoredItem_Notification1(MonitoredItem monitoredItem, MonitoredItemNotificationEventArgs e)
        {
            ...
            {
                ClientUtils.HandleException(this.Text, exception);
                Console.WriteLine("MonitoredItem_Notification1 " + exception);
            }
        }
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            //this.connectServerCtrl1.UserIdentity = new UserIdentity("", ""); //if you want to login with user and pass
        ...
        private void connectServerCtrl1_Load(object sender, EventArgs e)
        {
